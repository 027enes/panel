...
(function ($) {
    ...
    $('.vertical-counter, .counter, .progress-bar, .pie-chart-style-01, .pie-chart-style-02, .attractive-hover, .splitting-animation, .section-dark, footer, [data-anime], [data-fancy-text]').each(function () {
    ...
    if ($('.pie-chart-style-01').length) {
        if (typeof $.fn.easyPieChart === 'function') {
            var color1, color2;
            // Initialize the pie chart when the page is loaded
            $('.pie-chart-style-01').each(function () {
                $(this).easyPieChart({
                    trackColor: '#232323',
                    scaleColor: "",
                    lineCap: 'round',
                    ...
                    onStep: function (from, to, percent) {
                        $(this.el).find('.percent').html(Math.round(percent) + "%<br> Tamamlandı");
                    }
                });
            });
        }
    ...
    // Pie charts style 02
    if ($('.pie-chart-style-02').length) {
        if (typeof $.fn.easyPieChart === 'function') {
            var color1, color2;
            // Initialize the pie chart when the page is loaded
            $('.pie-chart-style-02').each(function () {
                $(this).easyPieChart({
                    trackColor: '#232323',
                    scaleColor: "",
                    lineCap: 'round',
