...
<section class="w-full h-full flex justify-center items-center flex-col">
        ...
        <div class="w-1/3 p-10 bg-white rounded-lg shadow-lg">
            <form action="register.php" method="post" class="mb-0  space-y-4 rounded-lg ">
                <p class="text-center text-2xl font-bold p-4" >Kayıt Ol</p>
          
                <div>
                  <label for="registerUsername" class="sr-only">Email</label>
          
                  <div class="relative">
                    <input type="text" name="registerUsername" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow" placeholder="Enter email" />
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="password" name="registerPassword" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow" placeholder="Enter password" />
                ...
                <p class="text-center text-sm text-gray-500">
                  Hesabın var mı?
                  <a class="underline" href="login.php">Giriş Yap</a>
                </p>
